document.addEventListener('DOMContentLoaded', () => {
    ...
    const messages = [
        ...
        {
            text: '<p>Я приходив на це місце, щоб хоть трошки, відчути те за чим скучав </p>',
        ...
        {
            text: '<p>Люблю твої милі відео</p>',
